...
time.sleep(10)
headers = [ "Star",	"Constellation",	"Right ascension",	"Declination",	"App.mag.",	"Distance (ly)",	"Spectral type",	"Brown dwarf",	"Mass (MJ)",	"Radius (RJ)",	"Orbital period (d)",	"Semimajoraxis (AU)",	"Ecc.", "Discovery year"]
planet_data = []
new_planet_data = []
def scrape():
    for i in range(1, 2):
